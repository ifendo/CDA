...
The **chi-square test** is used to compare two independent binomial proportions, p~1~,
and p~2~. Often, you want to compare the 'response' rates between a treated group and
a parallel control group.

The chi-square test is an approximate test, which may be used when the normal approximation
to the binomial distribution is valid.
